...
train_list = json.load(open("/content/multilabel-text-clf-main/multi_label_data/reuters/train_data.json", )) #change dataset name [ 'reuters', 'rcv1-v2', 'econbiz', 'amazon', 'dbpedia','nyt','goemotions']
...
test_list = json.load(open("/content/multilabel-text-clf-main/multi_label_data/reuters/test_data.json", )) #change dataset name
...
class_freq=pickle.load(open(os.path.join("/content/multilabel-text-clf-main/multi_label_data/reuters/class_freq.rand123"),'rb'))
train_num=pickle.load(open(os.path.join("/content/multilabel-text-clf-main/multi_label_data/reuters/train_num.rand123"),'rb'))
print(class_freq)
print(train_num)
